...
在浏览器中打开https://code.leaplearner.com，注册一个属于你自己的账号，用于保存学习进度，你的作品会被保存在网上哦。
...
var frog = new Sprite('http://rss.leaplearner.com/Image/Role/Frog1.png', 190, 250, height, 200);
frog.draw();

var cat = new Sprite('http://rss.leaplearner.com/Image/Animals/Cat.png', 360, 250, height, 200);
cat.draw();
